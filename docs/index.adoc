...
This guide provides a basic introduction to using Enonic XP in Headless CMS mode.
...
The Headless Movie DB application used to to bootstrap this project is based on the https://market.enonic.com/vendors/enonic/headless-cms-starter[Headless Starter]. 

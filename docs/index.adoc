...
The API browser will now load, and the documentation is available on the right hand side.
...
NOTE: Remember to replace `com.example.myproject` and `com_example_myproject` to match the name of your specific application (if you changed it during the project init).
